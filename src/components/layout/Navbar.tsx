  ...
  return (
    <nav className="flex justify-between items-center h-16 w-full px-7 border-b dark:border-neutral-700">
      ...
      <div className="flex items-center gap-3 md:gap-5">
        <div className="info  items-center gap-3 md:gap-5 flex">
          <Link
          ...
          >
            <svg
              ...
              height="17"
              viewBox="0 0 48 48"
              className="size-5 md:size-[17px] fill-neutral-400 dark:fill-neutral-500 group-hover:fill-yellow-500"
            >
            ...
            <span className="hidden md:flex text-sm font-medium group-hover:text-yellow-600">
              Docs
            </span>
          </Link>
